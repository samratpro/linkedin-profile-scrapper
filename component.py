    ...
    with sync_playwright() as playwright:
        ...
        while profile_number < all_profile_number:
            ...
            try:
                 ...
                 normal_linkedin_url = ''
                 toggle_button = profile_page.locator(
                 ...
                 if company_salse_page.count() > 0 and company_salse_page.get_attribute('href') != None:
                     ...
                     if more_element.count() > 0:
                         ...
                         if details_panel.count() > 0:
                             ...
                             type_e = profile_page.locator(
                                 "//dd[@class='company-details-panel__content company-details-panel-type t-black--light']")
                             type = type_e.inner_text() if type_e.count() > 0 else ''
                             founded_e = profile_page.locator(
                                 "//dd[@class='company-details-panel__content company-details-panel-founded t-black--light']")
...
def scrapper_loop(url, start_page_number, end_page_number, Output_Folder, browser_status, threads, log, close_event):
            ...
            while page_run <= end_page:
                ...
                for i in range(worker):
                    ...
                    if page_run <= end_page:
                        ...
                        futures.append(executor.submit(profile_scrapping, browser_status, page_run, url, close_event, Output_Folder, log))
                        page_run += 1
